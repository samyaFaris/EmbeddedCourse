...
int main()
{
    ...
    hospitalA.add_nurse_to_hospital("Kanar", "12345677", 3, "Kids");
    hospitalA.add_doctor_researcher_to_hospital("Basel", "12356718", "KidsEXP", "Kids");
    hospitalA.add_researcher_to_hospital("Sarah", "99999999");
    ...
    hospitalA.add_doctor_researcher_to_hospital("Samya", "78787878", "KidsEXP", "Kids");
